  ...
  return (
    <Box mb={10}>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        ...
        of MUI (previously Material-UI). The included demo pages don't replace
        the official ones, but provide a clear view of all new components and
        extended styles that this theme provides on top of MUI.
      </Typography>
      <Typography variant="subtitle1" gutterBottom my={4}>
